 ...
 <div class="container-fluid" id="container-wrapper">
     <div class="d-sm-flex align-items-center justify-content-between mb-4">
         ...
         <ol class="breadcrumb">
             ...
             <li class="breadcrumb-item active" aria-current="page"> Kelola Kapal</li>
         </ol>
     </div>
 </div>
 <div class="container">
 <div class="row">
    ...
    <div class="card">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                 <h6 class="m-0 font-weight-bold text-primary"> Kelola Kapal</h6>
                         ...
                         <?php $no = 1;
                            foreach ($data as $d) { ?>
                             <tr class="searchable-item">
                                 ...
                                 <td><?php echo $d->kapal; ?></td>
                                 <td>
                                 <div class="row">
                                            <div class="col-md-6">
                                                <div class="d-flex justify-content-end align-items-end">
                                                    <a class="btn btn-warning" href="<?php echo site_url('admin/edit_kapal/' . $d->id_kapal); ?>" onclick="return confirm('Anda yakin ingin mengedit data ini?');">
                                                        edit
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="order-first">
                                                    <a class="btn btn-danger" href="<?php echo site_url('admin/hapus_kapal/' . $d->id_kapal); ?>" onclick="return confirm('Anda yakin ingin menghapus data ini?');">
                                                        Hapus
                                                    </a>
                                                </div>
                                            </div>
     ...
     <div class="modal-dialog" role="document">
         <div class="modal-content">
             <div class="modal-header">
                 <h5 class="modal-title" id="exampleModalLabel">Form Tambah Kapal </h5>
                 <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                     <span aria-hidden="true">&times;</span>
                 </button>
             </div>
             <form class="user mt-2" action="<?php echo base_url() . 'admin/add_kapal'; ?>" method="post">
                 <div class="container row">
                     <div class="col-md-12">
                        <label for="cabang">Cabang</label>
                        <div class="form-group">
                            <select class="form-control" name="cabang" id="cabang2">
                            <option value="">All Cabang</option>
                                <?php foreach ($data_cabang as $row) { ?>
                                    <?php $selected = ($cabang == $row->id_cabang) ? "selected" : ""; ?>
                                    <option value="<?php echo $row->id_cabang; ?>" <?php echo $selected; ?>><?php echo $row->cabang; ?></option>
                     ...
                     <div id="submenu5"  class="col-md-12" style="display:none">
                         <label>kapal</label>
                         <div class="form-group">
                             <input class="form-control" type="text" name="kapal" id="kapal">
                         </div>
                     </div>
                 </div>
 ...
 <script>
    ...
    function updateCabangAndRedirect() {
        ...
        if (newCabang === "") {
            window.location.href = "<?php echo base_url('Admin/kapal_null/'); ?>";
        }else {
            var baseUrl = "<?php echo base_url('Admin/kapal/'); ?>";
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    for (var i = 0; i < response.length; i++) {
                        ...
                        if (response[i].journey === "On Board Journey") {
                            hasPortJourney = true;
                        }
                    }
                    ...
                    if (!hasPortJourney) {
                        ...
                        journeySelect.innerHTML = `<option value="" style="color: red;">On Board Journey Tidak Tersedia</option>`;
                        submenu5.style.display = "none";
                    } else {
                        $('#journey2 option:contains("On Board Journey")').prop('selected', true);
                        submenu5.style.display = "block";
                    }
                }
            });
