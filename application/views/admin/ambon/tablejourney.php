 ...
 <div class="container-fluid" id="container-wrapper">
     <div class="d-sm-flex align-items-center justify-content-between mb-4">
         <h1 class="h3 mb-0 text-gray-800"> Type Journey</h1>
         <ol class="breadcrumb">
             <li class="breadcrumb-item"><a href="./">Home</a></li>
             <li class="breadcrumb-item">Tables</li>
             <li class="breadcrumb-item active" aria-current="page"> Kelola Type Journey</li>
         </ol>
     </div>
 </div>
 <div class="container">
    ...
    <div class="card">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary"> Kelola Type Journey</h6>
                                    ...
                                    <div class="row">
                                            <div class="col-md-6">
                                                <div class="d-flex justify-content-end align-items-end">
                                                    <a class="btn btn-warning" href="<?php echo site_url('admin/edit_journey/' . $d->id_journey); ?>" onclick="return confirm('Anda yakin ingin mengedit data ini?');">
                                                        edit
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="order-first">
                                                    <a class="btn btn-danger" href="<?php echo site_url('admin/hapus_journey/' . $d->id_journey); ?>" onclick="return confirm('Anda yakin ingin menghapus data ini?');">
                                                        Hapus
                                                    </a>
                                                </div>
                                            </div>
 ...
 <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
     <div class="modal-dialog" role="document">
         <div class="modal-content">
             ...
             <form class="user mt-2" action="<?php echo base_url() . 'admin/add_journey '; ?>" method="post">
                 <div class="container">
                     <div class="row">
                        <div class="col-md-12">
                            <label for="cabang">Cabang</label>
                        ...
                        <div class=" col-md-12">
                            <label>Type Journey</label>
                            <div class="form-group">
                                <input class="form-control" type="text" name="journey" id="journey">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <span>Contoh : </span><span style="color:red;">Pre Journey</span>
                        </div>
                    </div>
                </div>
    ...
    function showSubmenu4() {
        ...
        if (selectedValueCabang === "") {
            ...
            $.ajax({
                ...
                method: "GET",
                data: { cabang: selectedValueCabang }, // Menggunakan selectedValueCabang yang sudah diambil
                dataType: "json",
