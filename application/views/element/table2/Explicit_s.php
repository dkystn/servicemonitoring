     ...
     <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
         <div class="modal-dialog" role="document">
             <div class="modal-content">
                 ...
                 <div class="container">
                     <form class="user mt-2" action="<?php echo base_url() . 'Element/add_explicit_p'; ?>" method="post">
                         <div class="container">

                             <label for="nik">Judul Khowladge</label>
                             <div class="form-group">
                                 <input class="form-control" type="text" name="judul_explicit" id="judul_explicit">
                             </div>
                             <label for="nama_user">Tanggal Buat</label>
                             <div class="form-group">
                                 <input class="form-control" type="date" name="tgl_explicit" id="tgl_explicit">
                             </div>
                             <label for="username">Keterangan</label>
                             <div class="form-group">
                                 <input class="form-control" type="text" name="keterangan_explicit" id="keterangan_explicit">
                             </div>
