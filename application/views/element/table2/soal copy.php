     ...
     <div class="row">
         <div class="col-lg-12 mb-4">
             ...
             <div class="card">
                 ...
                 <?php echo form_open_multipart('element/laporan'); ?>
                 ...
                 <div class="container ">
                     <div class="row">
                         ...
                         <div class="col-md-10 mb-3">:
                             <input type="text" name="nama" id="nama" style="width: 90%; ">
                         </div>
                         <div class="col-md-2">
                             <span>Tanggal</span>
                         </div>
 ...
 <script>
     $(document).ready(function() {
         ...
         $('select[name="regional"], select[name="type"], select[name="type_journey"], select[name="type_journey2"], select[name="type_option"], select[name="type_option2"], select[name="type_option3"], select[name="type_option4"], select[name="type_option5"], select[name="type_option6"], select[name="type_option7"], select[name="type_option8"], select[name="cabang"]').change(function() {
             ...
             if ((selectedRegional !== '0' && selectedType !== '0') || (selectedValue1 !== '0' && selectedValue2 === '0') || (selectedValue1 === '0' && selectedValue2 !== '0') || (selectedValue3 !== '0' || selectedValue4 !== '0' || selectedValue5 !== '0' || selectedValue6 !== '0' || selectedValue7 !== '0' || selectedValue8 !== '0' || selectedValue9 !== '0' || selectedValue10 !== '0') || selectedCabang !== '0') {
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-check form-check-inline" style="margin-left: 10px;">
                                                ...
                                                <input name="radio_${i + 1}" type="radio" class="custom-control-input" data-jawaban="jawaban_1" value="${response[i].jawaban_1}">
