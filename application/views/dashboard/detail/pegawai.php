                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            <div class="col-5 col-lg-5 searchable-item">
                                                                <div class="row">
                                                                <?php
                                                                        if ($item_kendaraan_item == 0) {
                                                                            $hasil_kendaraan = 0;
                                                                        } else {
                                                                            $hasil_kendaraan = $done_kendaraan_item / $item_kendaraan_item * 100;
                                                                        }
                                                                        ?>
                                                                    ...
                                                                    <div class="col-md-12 text-center mt-3">
                                                                        ...
                                                                        ?>%</span>
                                                                        <span style="font-size:10px;">(<?php echo $done_kendaraan_item; ?>/<?php echo $item_kendaraan_item; ?>)</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            <div class="col-5 col-lg-5 searchable-item">
                                                                <div class="row">
                                                                <?php
                                                                        if ($item_pejalankaki_item == 0) {
                                                                            $hasil_pejalankaki = 0;
                                                                        } else {
                                                                            $hasil_pejalankaki = $done_pejalankaki_item / $item_pejalankaki_item * 100;
                                                                        }
                                                                        ?>
                                                                    <div class="col-md-12">
                                                                    ...
                                                                    <div class="col-md-12 text-center mt-3">
                                                                        ...
                                                                        echo $roundedPercentage; // Mencetak nilai yang telah dibulatkan
                                                                        ?>%</span>
                                                                        <span style="font-size:10px;">(<?php echo $done_pejalankaki_item; ?>/<?php echo $item_pejalankaki_item; ?>)</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-7 col-lg-7 searchable-item">
    ...
    resetButton.addEventListener('click', function () {
        ...
        <script>
            ...
            function updateDateAndRedirect() {
                var journey_id = <?php echo $id_journey ?>;
                var newDate = document.getElementById("tanggal").value;
                window.location.href = "<?php echo base_url('Beranda/index_item/'); ?>"+ journey_id + "/" + newDate;
            }
