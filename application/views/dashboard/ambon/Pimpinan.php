            ...
            <div class="card shadow mb-4">
                    ...
                    <div class="row">
                        <div class="col-10 col-md-4">
                            ...
                            <div class="form-group">
                                <select class="form-control" name="cabang" id="cabang" disabled>
                ...
                <div class="row bg-center">
                    ...
                    <div class="col-11 col-lg-2 text-center bg-all" style="background-color: 
                                        ...
                                        if ($cabang && $j  && !$end || $cabang && $id_kapal  && !$end || $cabang && $id_pelabuhan  && !$end  || $j  && !$end || $id_pelabuhan && $end && $jumlah_query = 1) {
                                            // if($jumlah_data >= 2){
                        ...
                        <div class="row text-center">
                            <div class="col-md-12 searchable-item">
                                <?php //echo $count . '/' . $totalPoin . '/' . $cek .'/'.$jumlah_poin_all .'/'. $jumlah_data_all .'/'. $point .'/' . $total_nilai_json.'/'. $jumlah_query;
                                ?>
