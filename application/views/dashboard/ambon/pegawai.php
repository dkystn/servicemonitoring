                                    ...
                                    <div class="col-11 col-lg-2 text-center bg-all" style="background-color: <?php
                                        ...
                                        <div class="row text-center">
                                            ...
                                            <div class="col-md-12 mb-3 searchable-item">
                                                <a href="<?= base_url('Beranda/index_item/' . $item->id_journey); ?>" style="text-decoration: none; color:rgb(73, 73, 73);">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <?php foreach ($journey as $item) { ?>
                                                            <?php if ($item->journey == 'Pre Journey'): ?>
                                                                ...
                                                                <a href="<?= base_url('Beranda/index_item/' . $item->id_journey) . '/' . $today; ?>" style="text-decoration: none; color:rgb(73, 73, 73);">
    ...
    resetButton.addEventListener('click', function () {
        ...
        <script>
            ...
            function updateDateAndRedirect() {
                ...
                window.location.href = "<?php echo base_url('Beranda/index/'); ?>" + newDate;
            }
