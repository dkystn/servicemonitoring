 ...
 <div class="container-fluid" id="container-wrapper">
     <div class="d-sm-flex align-items-center justify-content-between mb-4">
         ...
         <ol class="breadcrumb">
             ...
             <li class="breadcrumb-item active" aria-current="page">Laporan Ditolak</li>
         </ol>
     </div>
     <div class="row">
    <?php
        ...
        <div class="col-md-6 searchable-item">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <a class="btn btn-warning " href="<?php echo site_url('pegawai/edit_laporan_tolak/' . $item->id_laporan) ?>">Edit</a>
                    <a class="btn btn-primary" href="<?php echo site_url('pegawai/laporan_detail/'.$item->id_laporan ) ?>">Lihat Detail</a>
                </div>
            </div>
        </div>
