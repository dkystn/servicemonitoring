...
! function(t, e) {
    ...
    var Ne = {
        ...
        acquireContext: function(t, e) {
            if (typeof t === "string") {
                ...
                t = t[0]; // Mengambil elemen pertama dari array
            }
            
            // Memeriksa apakah t ada dan memiliki properti canvas
            if (t && t.canvas) {
                t = t.canvas;
    ...
    ut.extend(ni.prototype, {
        construct: function(t, e) {
            ...
            }), n && a ? (i.initialize(), i.update()) : console.log("Failed to create chart: can't acquire context from the given item")
        },
        initialize: function() {
            var t = this;
